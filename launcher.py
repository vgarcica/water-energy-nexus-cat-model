...
def precomputar_dades_base(
    ...
    # -------------------------------------------------------------------------
    if verbose:
        print("  [1/6] Reescalant renovables a potència vigent...")
    ...
    # -------------------------------------------------------------------------
    if verbose:
        print("  [2/6] Aplicant correcció de tendència a cogeneració...")
    ...
    # -------------------------------------------------------------------------
    if verbose:
        print("  [3/6] Extraient autoconsum històric de la demanda...")
    ...
    # -------------------------------------------------------------------------
    if verbose:
        print("  [4/6] Reindexant nivells d'embassaments a freqüència horària...")
    ...
    # -------------------------------------------------------------------------    
    if verbose:
        print("  [5/6] Descomposició de la sèrie històrica...")
...
config = {
    ...
    # PROENCAT 2040
    'potencia_solar':      {'actiu': False,  'rang': np.arange(1000, 30100, 100),   'defecte': 17431},
    ...
    'max_desalation':      {'actiu': True,  'rang': np.arange(32, 97, 1),        'defecte': 64},
    'max_regen':           {'actiu': True,  'rang': np.arange(0.173, 0.351, 0.001), 'defecte': 0.350},
    'llindar_desal_max':   {'actiu': True,  'rang': np.arange(1, 5, 1),           'defecte': 2},
    ...
    'llindar_regen_max':   {'actiu': False,  'rang': np.arange(1, 5, 1),           'defecte': 1},
    'derivada_nivell':     {'actiu': False,  'rang': np.arange(0, 11, 0.5),       'defecte': 0.0},
    
    # --- Llindars de sequera (per increments) ---
    'x1_base_eme':         {'actiu': True, 'rang': np.arange(10, 21, 1),         'defecte': 16},
    'x2_gap_exc':          {'actiu': True, 'rang': np.arange(5, 21, 1),         'defecte': 9},
    'x3_gap_ale':          {'actiu': True, 'rang': np.arange(5, 21, 1),         'defecte': 15},
